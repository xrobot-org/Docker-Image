...
RUN cd ~/esp/esp-idf/components && wget "https://components.espressif.com/api/download/?object_type=component&object_id=3a7a8cea-c960-424e-87aa-ccc4cabfaa1e" -O libhelix-mp3.zip && unzip -o libhelix-mp3.zip
RUN cd ~/esp/esp-idf/components && wget "https://components.espressif.com/api/download/?object_type=component&object_id=c7fc5cb0-2480-4262-9221-4513747ebee6" -O mdns.zip && unzip -o mdns.zip
